...
import com.example.trabalho_bd3.domain.dto.usuario.UsuarioRequestDTO;
import com.example.trabalho_bd3.domain.dto.usuario.UsuarioResponseDTO;
import com.example.trabalho_bd3.domain.service.UsuarioService;
...
public class UsuarioController {
    ...
    cadastrar(@RequestBody UsuarioRequestDTO dto){
      UsuarioResponseDTO usuario = usuarioService
      .cadastrar(dto);
